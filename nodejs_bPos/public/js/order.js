...
const add_order_list = (menu_list)=>{
	...
	// 기존 div.order_list 가 있는지 확인하고 
	// div.order_list를 가져와서, 
	// 전체를 article.order_list로 부터 삭제하기
...
const order_input = (table_id, menu_id) =>{
	 ...
	 * localhost:3000/pos/order/3/input/5와 
	 * 같은 URL을 만들어 서버로 Request
	 * 이런식으로 만드는 URL방식을 RESTfull 요청 이라고한다.
	 */
...
// JS코드가 HTML에 어떤 부분에 있어도 상관없이 작동이 된다.
