 ...
 * 이처럼 모듈을 import하면 
 * 프로젝트에서는 이들을 middle ware가 설정(설치)되었다 라고 한다.
 * 
 */

var createError = require('http-errors');
// web application에서 사용자의 request URL을 처리하고
// response하는 역할을 수행하는 middle ware이며 , framewrok
...
// request에 따라오는 queryString 등을 처리하기 위한 용도
...
// ./routes 폴더에 있는 index.js file을 실행하여 
// 요청을 처리하라
// spring에서 class에 설정된 @RequestMapping에 해당하는 부분
var indexRouter = require('./routes/index');

// localhost:3000/ 요청이 오면
// ./routes 폴더에 있는 users.js file을 실행하여 
// 요청을 처리하라
